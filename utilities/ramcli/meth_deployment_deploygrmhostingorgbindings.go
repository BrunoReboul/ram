...
func (deployment *Deployment) deployGRMHostingOrgBindings() (err error) {
	...
	orgBindingsDeployment.Artifacts.OrganizationID = orgBindingsDeployment.Core.SolutionSettings.Hosting.OrganizationID
