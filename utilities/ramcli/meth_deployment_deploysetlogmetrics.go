...
import "github.com/BrunoReboul/ram/services/setlogmetrics"

func (deployment *Deployment) deploySetLogMetrics() (err error) {
	instanceDeployment := setlogmetrics.NewInstanceDeployment()
