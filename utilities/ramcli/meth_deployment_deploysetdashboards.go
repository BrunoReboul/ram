...
import "github.com/BrunoReboul/ram/services/setdashboards"

func (deployment *Deployment) deploySetDashboards() (err error) {
	instanceDeployment := setdashboards.NewInstanceDeployment()
