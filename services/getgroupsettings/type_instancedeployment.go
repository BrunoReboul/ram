...
func projectDeployExtendedRole() (role iam.Role) {
	role.Title = "ram_getgroupsettings_deploy_extended"
	role.Description = "Real-time Asset Monitor get group settings microservice extended permissions to deploy"
	role.Stage = "GA"
	role.IncludedPermissions = []string{
