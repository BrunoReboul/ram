...
func monitoringOrgRunRole() (role iam.Role) {
	role.Title = "ram_stream2bq_monitoring_org_run"
	role.Description = "Real-time Asset Monitor stream to bigquery microservice permissions to run on monitoring org"
	role.Stage = "GA"
...
func projectRunRole() (role iam.Role) {
	role.Title = "ram_stream2bq_run"
	role.Description = "Real-time Asset Monitor stream to bigquery microservice permissions to run"
	role.Stage = "GA"
	role.IncludedPermissions = []string{
...
func projectDeployCoreRole() (role iam.Role) {
	role.Title = "ram_stream2bq_deploy_core"
	role.Description = "Real-time Asset Monitor stream to bigquery microservice core permissions to deploy"
	role.Stage = "GA"
	role.IncludedPermissions = []string{
		"pubsub.topics.get",
...
func projectDeployExtendedRole() (role iam.Role) {
	role.Title = "ram_stream2bq_deploy_extended"
	role.Description = "Real-time Asset Monitor stream to bigquery microservice extended permissions to deploy"
	role.Stage = "GA"
	role.IncludedPermissions = []string{
