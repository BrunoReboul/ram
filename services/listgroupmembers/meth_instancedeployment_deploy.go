...
func (instanceDeployment *InstanceDeployment) Deploy() (err error) {
	...
	log.Printf("%s this cloud function service account needs oauth scope https://www.googleapis.com/auth/admin.directory.group.member.readonly", instanceDeployment.Core.InstanceName)
